  ...
  test("returns nearby items sorted by distance", async () => {
    ...
    setupMocks({
      foodAssets: [
        ...
        {
          id: "fa-2",
          uniqueName: `LunchSwap_foodItem|banana|common|${now}`,
  ...
  test("filters out expired items (>24h) and deletes them", async () => {
    ...
    setupMocks({
      foodAssets: [
        ...
        {
          id: "fa-2",
          uniqueName: `LunchSwap_foodItem|banana|common|${fresh}`,
          position: { x: 110, y: 210 },
          deleteDroppedAsset: jest.fn(),
        },
      ],
  ...
  test("skips items with malformed uniqueName", async () => {
    ...
    setupMocks({
      foodAssets: [
        {
          id: "fa-1",
          uniqueName: "LunchSwap_foodItem|apple",
          position: { x: 110, y: 210 },
          deleteDroppedAsset: jest.fn(),
        },
        {
  ...
  test("skips items with unknown itemId not in inventory cache", async () => {
    ...
    setupMocks({
      foodAssets: [
        {
          id: "fa-1",
          uniqueName: `LunchSwap_foodItem|unknown-food-xyz|common|${now}`,
          position: { x: 110, y: 210 },
          deleteDroppedAsset: jest.fn(),
        },
        {
