 ...
 * Applies rarity multiplier,  meal bonus, and optional hot streak multiplier.
 */
export const calculatePickupXp = (rarity: Rarity, matchesTargetMeal: boolean, xpMultiplier: number = 1): number => {
  ...
  if (matchesTargetMeal) {
    xpEarned += XP_ACTIONS.COLLECT_TARGET_ITEM;
  }
